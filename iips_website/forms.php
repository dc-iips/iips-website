												...
												<div class="row">
													<div class="col-sm-12">
														...
														<div class="input-group">
															...
															<div class="input-group-btn">
																<button type="button" class="btn btn-default" tabadmin="-1">Action</button>
																<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" tabadmin="-1">
