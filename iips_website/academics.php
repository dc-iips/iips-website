...
<html lang="en">
  <head>
    ...
    <title>Academics | International Institute of Professional Studies, Devi Ahilya Vishwavidhalay</title>
    <!-- Bootstrap -->
        ...
        <div class="col-md-6">
            <div class="row">
                ...
                <div class="col-md-8 overview-text">
                    ...
                    <p>Explore undergraduate and graduate programs, research and professional development opportunities which will enhance your career.</p>
                </div>
            </div>
            <br/>
            <br/>
