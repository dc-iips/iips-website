...
<html lang="en">
  <head>
    ...
    <title>CET | International Institute of Professional Studies, Devi Ahilya Vishwavidhalay</title>
    <!-- Bootstrap -->
  ...
  <div class="row">
    ...
    <div class="col-md-9">
        ...
        <div role="tabpanel" class="tab-pane" id="tab2">
                  ...
                  <li class="text-justify">
                    The candidates awaiting their results of qualifying examination can also apply for admission but the candidate has to submit the final mark sheet of qualifying examination by the date as decided by the University.<br>
                  </li> 

                  <li class="text-justify">
                     Candidates who have passed their qualifying examination from universities other than Devi Ahilya University are required to submit Eligibility Certificate issued by the Devi Ahilya University, Indore. <br>
                  </li>
                  ...
                  <p class="text-justify"> A. Foreign Nationals / Person of Indian Origin (PIO) : (a) Foreign Nationals : Citizen of all countries other than who are not of India origin as defined under PIO. Foreign student in this context shall be defined as the student who possesses the foreign passport.  <br>
                    ...
                    <br>
                    (e) Certificate from District Administration / Police Department that candidate name has been enrolled in the register of foreign nationals. <br>
                    (f) Produces original certificates of qualifying examinations. <br><br>

                    The Eligibility Certificate and other documents will be issued to the candidate in person, on production of valid evidence of identity. The student should necessarily present himself/ herself. The certificates will not be granted and issued to his agents/ representatives/ friends etc. whosoever and whatsoever. Attested photocopy of all the above documents should be submitted at the time of admission. <br><br>

                    B. NRI - Non-Resident Indian As per Income Tax Act, 1961 an individual is non-resident for income tax purpose, when he/she is not a resident or who is not ordinarily resident. A person is treated as ordinarily resident when any of the following conditions is satisfied. <br><br>

                    <li class="text-justify"> If he/she has not been resident of India in nine out of ten preceding years. </li>
                    <li class="text-justify"> If he/she has not been in India for a period of 730 days or more during the preceding seven years. </li> <br>

                    Candidates who are seeking admission against seats reserved for non-resident Indians subject to the following conditions :<br>
                    <li class="text-justify"> At least one of the parents of such candidates should be non-resident Indian and shall ordinarily be residing abroad as non-resident Indian; </li>

                    <li class="text-justify"> The person who sponsors the candidate for admission should be a first degree relation of the candidate and should be ordinarily residing abroad as a non-resident Indian; </li>
                  ...
                  <h4><u><b> Reservation Policy and Conversion Of Seats</b></u></h4> <br>
                    ...
                    <li class="text-justify"> Of the total seats, 16 % and 20 % seats in courses will be reserved for applicants belonging to Scheduled Caste (SC) and Scheduled Tribes (ST) respectively. Seats of both these categories are interchangeable. </li>

                    <li class="text-justify"> Of the total seats in a course, 14 percent seats will be reserved for applicants form OBC category (except who are in creamy layer). </li>

                    <li class="text-justify"> Reservation for Persons with disabilities (Physically Handicapped Seats): One seat on over and above basis in each course will be reserved for the physically handicapped candidates with disability percentage of 40 or above. Candidate’s claiming admission against these seats shall be required to produce Disability Certificate from the concerned District Medical Board. </li>

                    <li class="text-justify"> A horizontal reservation of 30 percent of the total seats will be for women applicants. </li>

                    <li class="text-justify"> DAVV Employee ward quota : Admission for wards of the University employees will be done on the basis of University guidelines. These admissions will be over and above the total number of seats available in the concerned course. <br>
                    <b> (Ward here would mean husband, wife, son, daughter of the employee/teacher/officer. In this respect a certificate from the Registrar, Devi Ahilya University, Indore /Competent authority of the University shall be required) </b> <br>
                    Note: These seats are interchangeable, and can be converted to other category (Officer/Teacher to Employee or Vice -Versa) if they remain vacant. </li>
             
                    <li class="text-justify"> If less than half seat falls under reservation then the seat will not be available, but in case the proportion of seat is between half and one it will be treated as one. </li>

                    <li class="text-justify"> If reserved seats remain vacant on the day of counseling, the seat will be converted to general category on the basis of merit. </li>

                    <li class="text-justify"> To avail benefit of reservation a certificate from a Competent Authority should be produced. </li>

                    <li class="text-justify"> The candidate (applicants) must indicate explicitly the category for which he / she wants to avail the advantage of reservation for admission. This option will, in no case, be allowed to be changed. </li>

                    <li class="text-justify"> The candidate admitted under NRI category will not be transferred to any other category unless he/she has qualified entrance test and stands in merit. </li>

                    <li class="text-justify"> Conversion of vacant seats among reserved categories (SC / ST / OBC) will be done as per M.P. Government directives. </li>

                    <li class="text-justify"> <b> J &amp; K Migrants quota seats: </b> One seat in each program shall be reserved for sons/daughters of the persons displaced from the state of Jammu and Kashmir settled in M.P. on or before 1st January, 1999. Such candidates shall have to produce a certificate from the S.D.O. (Revenue) of the concerned district in prescribed Performa. <br>
                    Sons/ Daughters of the employees of M.P. Govt., who have served in the State of Jammu and Kashmir for curbing insurgency, are also covered under this quota. <br>
                    Such candidates should have passed their qualifying examination from the State of Jammu and Kashmir. Candidates would be required to produce a certificate in prescribed Performa. The certificate should be produced at the time of counseling. 
                    </li>
                  ...
                  <h4><u><b> Entrance Test </b></u></h4>
                     ...
                     1. The Test for Group B &amp; G shall include 75 questions in all, following section will have 15 questions each <br>
                        
                      <li class="text-justify"> Quantitative Ability </li>
                      <li class="text-justify"> Data Interpretation </li>
                      <li class="text-justify"> Logical Reasoning and General Intelligence </li>
                     ...
                     2. The Test for Group C, shall include total 75 question of which 15 questions will be from English and 20 questions each from Physics, Mathematics/Biology/Bio Technology and Chemistry.
                      ...
                      <li class="text-justify"> MBA (HA) : English, Physics, Biology, Chemistry </li>
                      <li class="text-justify"> MCA, M. Tech. &amp; B. Pharm.: English, Physics, Mathematics, Chemistry (Students who do not opt for Mathematics will not be considered for MCA/M.Tech/BCA.) </li> <br>

                    <h4><u><b> Courses After Graduation </b></u></h4>

                      <b> 1. There will be a common test paper for Group A </b>

                      <p> The papers will have objective type questions, having choices a, b, c, d and e each. The response sheet should be carefully filled up by the candidate as instructed on the question-paper booklet. The written test papers will be in English. The candidate can opt for all the groups test, if eligible. The test timings will be different.  </p>

                      The test of <u> Group A </u> shall include 75 questions in all, following section will have 15 questions each :
             
                       <li class="text-justify"> Quantitative Ability </li>
                       <li class="text-justify"> Data Interpretation </li>
                       <li class="text-justify"> Logical Reasoning and General Intelligence </li>
                       <li class="text-justify"> English Language Comprehension </li>
                       <li class="text-justify"> General Awareness and Awareness of Socio-Economic environment </li> <br>

                      <b> 2. </b> The Test for Group D shall include 75 questions in all. A candidate will choose any three subjects from the following list. Each subject will have 25 questions. <br>
                      Subjects : Physics / Zoology / Botany / Bio-Technology / Bio-Chemistry / Maths / Computer / Chemistry / Statistics / Electronics / Micro Biology. <br><br>

                      <b> 3. </b> The Test for Group E shall include 75 questions of which 15 questions will be from Numerical Ability section, and 20 questions each from remaining sections : 

                       <li class="text-justify"> Data Interpretation </li>
                       <li class="text-justify"> Logical Reasoning and General Intelligence </li>
                       <li class="text-justify"> Numerical Ability </li>
                       <li class="text-justify"> General Awareness and Awareness of Socio-Economic environment </li>  <br>

                     <b> 4. </b> The Test for Group F shall include Law / Library Science / Hindi / Sanskrit as subjects. Each subject will have 75 questions. A candidate will choose one subject as per eligibility. <br><br>

                      <h4><u><b> Test Centers </b></u></h4>
                       <p> The examination centers will be at Indore, Bhopal, Gwalior, Raipur, Allahabad, Kota, and Delhi. Time and venue of test will be given along with admit card. University reserves the right to withdraw and allocate another center. </p>
                      <br>

                    <h4><u><b> Admission in the Examination Hall : </h4></u></b> 

                         <li class="text-justify"> Candidates shall be strictly under the administrative control of the Centre Superintendent during the test. </li>
                         <li class="text-justify"> Mobile Phone, Pager, Calculator and other similar electronic equipments shall not be allowed in the examination hall. </li>
                         <li class="text-justify"> Use of any kind of unfair means in the examination shall automatically disqualify the candidature.  </li> <br>

                    <h4><u><b> Valuation : </b></u></h4>
                          The scheme of negative marking will be followed. 
                        <h4><u><b> Declaration of Result: </b></u></h4>

                        <p> The list of all candidates who appear for the Entrance Test, Category wise/ group-wise, indicating their merit will be displayed on the University/ Individual institute notice boards as well as on the University website (www.dauniv.ac.in). However candidates in their order of merit in different categories will be called for counseling. The selection of a candidate for a particular programme shall be decided by the Admission Committee at the time of counseling. </p> 
             
                    <h4><u><b> In case of tie at the same rank : </b></u></h4>

                       <p> In case of Tie (more than one student on the same rank) in the admission on any rank, admission will be given as under : <br>
