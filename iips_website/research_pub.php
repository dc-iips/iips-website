        ...
        <div class="tab-content">
           <div role="tabpanel" class="tab-pane" id="tab1">
            ...
            <div role="tabpanel" class="tab-pane" id="tab2">
                ...
                <?php include 'research_publication/apd.php'; ?>
            </div>
            ...
            <div role="tabpanel" class="tab-pane" id="tab6">
                ...
                <?php include 'research_publication/cpc.php'; ?>
              </div>  
            ...
            <div role="tabpanel" class="tab-pane" id="tab8">
                <h3 class="text-center"><b>Training Courses, Teaching-Learning-Evalution Technology, Faculty Development Programmes</b> </h3> 
                <?php include 'research_publication/fdp.php'; ?>
            </div>  

            <div role="tabpanel" class="tab-pane" id="tab9">
                <h3 class="text-center"><b>Papers presented in Conferences, Seminars, Workshops, Synopsis</b> </h3> 
                <?php include 'research_publication/ppc.php'; ?>   
            </div>  

            <div role="tabpanel" class="tab-pane" id="tab10">
                <h3 class="text-center"><b>Invalid Lectures and Chairmanship at National or International Conference Seminar</b> </h3> 
