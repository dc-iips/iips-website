  ...
  <div class="row , minlength">
    <div class="col-md-3" id="sidebar">
      <ul class="nav nav-stacked" role="tablist">
        ...
        <li role="presentation" id="colm" onClick="getData('research_publication/ppij.php', 'tab1')"><a href="#tab1" aria-controls="tab1" role="tab" data-toggle="tab"><span class="fa fa-hand-o-right"></span>&nbsp;Published Papers in Journals</a></li>
        ...
        <li role="presentation" id="colm" onClick="getData('research_publication/ppc.php', 'tab1')"><a href="#tab1" aria-controls="tab1" role="tab" data-toggle="tab"><span class="fa fa-hand-o-right"></span>&nbsp;Papers Presented in Conferences, Seminars, Workshops, Symposia</a></li>
        <li role="presentation" id="colm" onClick="getData('research_publication/ilc.php', 'tab1')"><a href="#tab1" aria-controls="tab1" role="tab" data-toggle="tab"><span class="fa fa-hand-o-right"></span>&nbsp;Invited Lectures and Chairmanship at National or International Conference/ Seminar</a></li>
      </ul>
    </div>
    <div class="col-md-9">
