  ...
  <div class="row">
    <div class="col-md-3" id="sidebar">
      <ul class="nav nav-stacked" role="tablist">
        ...
        <li role="presentation" id="colm" class="active"><a href="#tab1" aria-controls="tab1" role="tab" data-toggle="tab"><span class="fa fa-hand-o-right"></span>&nbsp;MCA-6Years</a></li>
        <li role="presentation" id="colm"><a href="#tab2" aria-controls="tab2" role="tab" data-toggle="tab"><span class="fa fa-hand-o-right"></span>&nbsp;M.Tech(IT)</a></li>
        <li role="presentation" id="colm"><a href="#tab3" aria-controls="tab3" role="tab" data-toggle="tab"><span class="fa fa-hand-o-right"></span>&nbsp;MBA(MS)5Years</a></li>
        ...
        <li role="presentation" id="colm"><a href="#tab5" aria-controls="tab5" role="tab" data-toggle="tab"><span class="fa fa-hand-o-right"></span>&nbsp;MBA(TA)2Years</a></li>
    ...
    <div class="col-md-9">
      <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="tab1">
            <h3 class="text-center"><b>MCA - 6Year Syllabus</b></h3><br>
            <div class="row">
        ...
        <div role="tabpanel" class="tab-pane" id="tab2">
            <h3 class="text-center"><b>M.Tech(IT) - Syllabus</b></h3><br>
            <div class="row">
            	<div class="col-md-4 col-sm-6 col-xs-6">Semester - I - <a href="pdf_server.php?file=static/pdf/MCA_I.pdf">Download</a></div>    	
           ...
           <span class="hidden-sm hidden-xs"><br><br></span>
            ...
            <h3 class="text-center"><b>MBA(MS) - Syllabus</b></h3><br>
            <div class="row">
            	<div class="col-md-4 col-sm-6 col-xs-6">Semester - I - <a href="pdf_server.php?file=static/pdf/MCA_I.pdf">Download</a></div>    	
            	<div class="col-md-4 col-sm-6 col-xs-6">Semester - II - <a href="pdf_server.php?file=static/pdf/MCA_I.pdf">Download</a></div>    	
        ...
        <div role="tabpanel" class="tab-pane " id="tab4">
            <h3 class="text-center"><b>MBA(APR) - Syllabus</b></h3><br>
            <div class="row">
        ...
        <div role="tabpanel" class="tab-pane " id="tab5">
            <h3 class="text-center"><b>MBA(TA) - Syllabus</b></h3><br>
                        <div class="row">
            	<div class="col-md-4 col-md-offset-2 col-sm-6 col-xs-6">Semester - I - <a href="pdf_server.php?file=static/pdf/MCA_I.pdf">Download</a></div>    	
            	<div class="col-md-4 col-sm-6 col-xs-6">Semester - II - <a href="pdf_server.php?file=static/pdf/MCA_I.pdf">Download</a></div>    	
           <span class="hidden-sm hidden-xs "><br><br></span>
        ...
        <div role="tabpanel" class="tab-pane " id="tab6">
         ...
         <div role="tabpanel" class="tab-pane " id="tab7">
            <h3 class="text-center"><b>B.Com(Hons.) - Syllabus</b></h3><br>
            <div class="row">
            	<div class="col-md-4 col-sm-6 col-xs-6">Semester - I - <a href="pdf_server.php?file=static/pdf/MCA_I.pdf">Download</a></div>    	
            	<div class="col-md-4 col-sm-6 col-xs-6">Semester - II- <a href="pdf_server.php?file=static/pdf/MCA_I.pdf">Download</a></div>    	
