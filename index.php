...
<body>
  ...
  <div class="carousel-inner" role="listbox">
      <div class="item active">
          <img src="images/slider/slider1.jpg" alt="..." class="slider-size">
          <div class="carousel-caption">
          </div>
      </div>

      <div class="item">
          <img src="images/slider/slider2.jpg" alt="..." class="slider-size">
          <div class="carousel-caption">
          </div>
      </div>

      <div class="item">
          <img src="images/slider/slider3.jpg" alt="..." class="slider-size">
          <div class="carousel-caption">
          </div>
      </div>

      <div class="item">
          <img src="images/slider/slider4.jpg" alt="..." class="slider-size">
          <div class="carousel-caption">
          </div>
      </div>
      ...
      <div class="container">
  		  <div class="row">
	    	  	...
	    	  	<div class="col-md-4"><br>
      				<h4 class="heading-color">News &amp; Announcements</h4>
            		<div class="row">
