...
<div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <p id="content">This is our development team, who have contributed to the developement of the IIPS website and made this possible to deploy this website within the time.</p>
            </div>
        </div>
            ...
            <div class="row">
              <h2 class="text-center">Core Developers</h2><br>
                ...
                <div class="col-lg-4 col-sm-4 text-center">
                  ...
                  <h3>Shubham Neema<br><small>Front-End Developer</small></h3>
                  <p>
